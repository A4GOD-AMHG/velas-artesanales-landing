<template>
  <footer class="bg-white border-t border-[#f0e4e6] py-12">
    <div class="flex justify-center px-4 md:px-10 lg:px-40">
      <div class="flex flex-col md:flex-row justify-between items-center max-w-240 flex-1 gap-6">
        <div class="flex items-center gap-2">
          ...
          <span class="font-bold text-[#4a3b3e]">Lumina</span>
        </div>
        <div class="flex gap-6 text-sm text-[#8f6e74]">
        ...
        <div class="text-xs text-[#8f6e74]">
          © 2023 Lumina Academy. Todos los derechos reservados.
        </div>
      </div>
    </div>
  </footer>
